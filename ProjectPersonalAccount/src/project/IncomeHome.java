...
/**
 * Servlet implementation class IncomeHome
 */
@WebServlet("/IncomeHome")
public class IncomeHome extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println(
				"<form id=\"incomesForm\" name=\"incomesForm\"  method=\"post\" action=\"IncomeController\">");
		out.println("<p class=\"contact\">");
		out.println("<label for=\"name\">Income</label>");
		out.println("</p>");
		out.println(
				"<input id=\"inc_ac\" name=\"inc_ac\" placeholder=\"Name \" required=\"\" tabindex=\"1\" type=\"text\" >");
		out.println("<p class=\"contact\">");
		out.println("<label for=\"phone\">Category</label>");
		out.println("</p>");
		out.println(
				"<input id=\"inc_catid\" name=\"inc_catid\" placeholder=\"category id \" required=\"\" tabindex=\"1\" type=\"text\" >");
		out.println("<p class=\"contact\">");
		...
		out.println("<p class=\"contact\">");
		out.println("<label for=\"ephone\">Receiveby</label>");
		out.println("</p>");
		out.println(
				"<input id=\"receiveby\" name=\"receiveby\" placeholder=\"cash or bank \" required=\"\" tabindex=\"1\" type=\"text\" >");
		out.println("<p class=\"contact\">");
		...
		out.println("<input name=\"inc_id\" id=\"inc_id\"   type=\"hidden\">");
