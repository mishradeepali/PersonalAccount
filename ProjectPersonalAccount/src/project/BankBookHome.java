...
/**
 * Servlet implementation class BankBookHome
 */
@WebServlet("/BankBookHome")
public class BankBookHome extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println(
				"<link rel=\"stylesheet\" type=\"text/css\" href=\"/ProjectPersonalAccount/resources/emo.css\" media=\"all\" />");
		out.println("</head>");
		out.println("<body>");
		out.println("<div class=\"container\">");
		out.println("<header>");
		out.println("<h1>Bank Book </h1>");
		out.println("</header>");
		...
		ArrayList<BankBookPojo> catList = (ArrayList<BankBookPojo>) request.getAttribute("catList");
		for (BankBookPojo cat : catList) {
			out.println("<tr>");
